    ...
    <Stack>
      <Grid container>
        <Grid item xl={12} mt={2}>
          <NavLink style={navLinkStyle}>
            <Typography variant='h6' fontWeight='bold'>Schools <ArrowOutwardIcon sx={{fontSize: 18}}/></Typography>
          </NavLink>
        </Grid>
      </Grid>
      ...
      <Grid container mt={2}>
        <Grid item xl={12} display='flex' justifyContent='center'>
            <Button variant='contained' sx={{height: 44, width: 200}}>More +9 School</Button>
        </Grid>
      </Grid>
    </Stack>
  )
